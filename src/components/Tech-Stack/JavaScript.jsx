...
function JavaScript() {
    ...
    const javaScriptList = javascriptData;
    const { searchInput, setSearchInput, debouncedSearch, filteredList } = useQaSearch(javaScriptList);
    ...
    return (
        <div className="container">
            <TechStackSearchFilter
                ...
                ariaLabel="Search JavaScript Q&A"
            />
